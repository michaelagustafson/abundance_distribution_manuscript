...
```{r}
#allCovs_std <- read.csv("F:/gyrf_analysis/MSgyrfalcon/squir_final_df_28Dec23.csv")
#allCovs_std <- allCovs_std[,c(-1)]



df2 <- read.csv("F:/gyrf_analysis/MSgyrfalcon/MSgyrfalcon/squir_time_df_5Sept2024.csv")
df2 <- df2[,c(-1)]
```
