...
```{r}
allCovs_std <- read.csv("F:/gyrf_analysis/MSgyrfalcon/wipt_final_df_28Dec23.csv")
...
ggsave("D:/gyrf_analysis/abundance plots 22Mar24/wipt_tall.png", width = 7, height = 7, dpi = 300, limitsize = FALSE)
```
